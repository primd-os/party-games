...
execute at @e[type=marker,x=0,tag=pg.ds.grower,limit=1] run setblock ~ ~ ~ minecraft:big_dripleaf
...
execute if score playercount pg.ds.Variables matches ..1 run function partygames:main/endgame